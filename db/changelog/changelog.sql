...
-- changeset carla:8
CREATE TABLE "organizer_requests" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "user_id" BIGINT NOT NULL, CONSTRAINT "organizer_requests_pkey" PRIMARY KEY ("id"));
-- rollback ALTER TABLE "organizer_requests" DROP CONSTRAINT "organizer_requests_pkey";
-- rollback DROP TABLE "organizer_requests";
