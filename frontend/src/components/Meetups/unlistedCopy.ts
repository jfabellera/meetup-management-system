export const UNLISTED_SLUG_NOTE =
  "Unlisted only hides this meetup from public listings. Anyone with the link can still open it. Use a hard-to-guess URL slug if you don't want it discovered.";
